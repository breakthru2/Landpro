                    ...
                    <?php 
                        if (!empty($agents)) {
                            foreach ($agents as $agent) {
                                extract($agent); 
                                $totalprop = totalAgentProp($agent_id); ?>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <!-- agency item #1 -->
                        <div class="agency-item">
                            <div class="agency--img">
                                <a href="agency-profile.html">
                        <img src="prop_uploads/thumb_09.jpg" alt="agency" class="img-responsive">
                        </a>
                            </div>
                            <!-- .agency-img end -->
                            <div class="agency--content">
                                <div class="clearfix mb-30">
                                    <div class="pull-left">
                                        <h5 class="agency--title"><a href="agency-profile.html"><?php echo "$firstname $lastname;" ?></a></h5>
                                        <span class="agency--location"><i class="fa fa-map-marker"></i><?php echo $address; ?></span>
                                    </div>
                                    <div class="pull-right">
                                        ...
                                        <span class="Properties--number"><?php echo $totalprop; ?> Property</span>
                                    </div>
                                </div>
                                <div class="agency--details">
                                    <p>An agent in LandProp Organization, very good in selling and buying of comfortable and eficient houses. consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor.</p>
                                </div>
                                <!-- .agency-details end -->
