<?php 
    ...
    if (isset($_GET['a_id'])) {
        ...
        $result = selectQuery('agents', 'agent_id', $agent_id);
        if ($result) {
            $agents = $result;
        }
    }

    $response = selectQuery('listings', 'agent_id_fk', $agent_id);
    if ($response) {
        $listings = $response;
    }
 ?>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-5 col-md-5">
                <div class="agent--profile-img">
                    <img src="prop_uploads/thumb_09.jpg" alt="agent" />
                </div>
            </div>
            <!-- .col-md-5 end -->
            <?php 
            ...
            <div class="col-xs-12 col-sm-6 col-md-5 col-md-offset-1">
                <div class="agent--profile-content">
                    ...
                    <div class="agent--profile-details">
                        <p>Agent <?php echo "<b>$firstname $lastname</b>"; ?> have been one of our trsted agents, he has been of great help to the organization and to the society at large</p>
                    </div>
                    <!-- .agent-profile-details end -->
                    <div class="agent--profile-contact">
                        <ul class="list-unstyled mb-20 clearfix">
                            <li><span>Phone:</span><?php echo $tel; ?></li>
                            <li><span>Email:</span><?php echo $email; ?></li>
                            <li class="text-lowercase"><span>Website:</span><?php echo "$firstname$lastname"; ?></li>
                        </ul>
                    </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="heading heading-2  mb-70">
                    <h2 class="heading--title"><?php echo $firstname ?>'s Properties</h2>
                </div>
                <!-- .heading-title end -->
            </div>
            <!-- .col-md-12 end -->
                    ...
                    <div class="property-item">
                        ...
                        <div class="property--content">
                            <div class="property--info">
                                ...
                                <p class="property--location"><?php echo $address; ?></p>
